...
export function useAllPlayerTotalStats () {
    ...
    var isLoading = stats2021.isLoading || stats2020.isLoading || stats2019.isLoading
    var data = isLoading ? [] :  [...stats2021.data.data,...stats2020.data.data,...stats2019.data.data]
    var error = stats2021.error || stats2020.error || stats2019.error
    return { 
        data: data,
        isLoading: isLoading,
        error: error
