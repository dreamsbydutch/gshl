...
import { PlayerTotalsType, PlayerNHLType, QueryKeyType, PlayerSplitsType, PlayerWeeksType, PlayerDaysType, PlayerDraftHistoryType, TeamInfoType, TeamDaysType, Seasons, TeamWeeksType, TeamTotalsType } from "./endpointTypes"
...
export function usePlayerDays(player?: { 'PlayerName': string, 'PosGroup': 'F' | 'D' | 'G' }) {
    let statQueries: (PlayerDaysType[] | PlayerDaysType | null)[] = useQueries(
        seasons.map((season) => {
